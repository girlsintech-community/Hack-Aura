      ...
      <div className="code-container">
        <section className="code-section" id="code-of-conduct">
          ...
          <ul className="code-list">
            ...
            <li><span className="abc">Reporting and Resolution:</span>
              If you face or witness any concerning behavior, please report it immediately to the organizing team. You can do so anonymously or directly. All reports will be treated with confidentiality and seriousness.
              Organizers are empowered to take appropriate action, which may include verbal warnings, removal from the event, or disqualification.
