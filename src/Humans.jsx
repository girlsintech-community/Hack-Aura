...
const TeamPage = ({ onContactClick }) => {
  ...
  const allTeam = [
    ...
    { name: "Z_Manik", role: "Lead Organizer", department: "Core", linkedin: "https://www.linkedin.com/in/mrmanik", image: '/images/teams/manik.webp', location: "Haryana" }
  ];
      ...
      >
        ...
        <div className="name-header" style={{ height: '40px', padding: '0.5rem' }}>
          <p style={{
            ...
            {member.name === 'Z_Manik' ? 'Manik' : member.name}
          </p>
        </div>
      </div>
    );
