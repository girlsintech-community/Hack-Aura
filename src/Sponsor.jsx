...
const HackathonSponsors = () => {
  ...
  const partnerLogos = [
    ...
    { id:37, src: bvcoe, url:"https://www.ieeebvcoe.in/" },
    { id:38, src: chain, url:"https://www.instagram.com/chain_chapter/?igsh=bWd4OGlhZm9lZHZu#" },
    { id:39, src: girlsWhoML, url:"https://www.girlswhoml.com/" },
    { id:40, src: globe, url:"https://www.linkedin.com/company/women-ai-co/" },
    { id:41, src: hh, url:"https://linkedin.com/company/hack-halt" },
    { id:42, src: leni, url:"https://www.linkedin.com/company/leni-institute-of-technology/" },
    { id:43, src: metamorphosis, url:"https://metamorphosis.octaloop.com/" },
    { id:44, src: nitra, url:"https://www.linkedin.com/in/geeksforgeeks-ntc/" },
    { id:45, src: red, url:"https://hackshastra.in/" },
    { id:46, src: techno, url:"https://www.instagram.com/technoryx_official?utm_source=qr&igsh=MWwwaDBtZWk5dm9sdg==" },
  ];
  return (
